---
title: "Carsharing service launch with cloud-based fleet operations (GAM-CAR5)"
client_side_industry: [transport]
my_side_industry: [consulting, it-services]
engagement: [external]
client_name_visibility: [hidden]
project_code: [GAM-CAR5]
functional: [mobility, fleet-management]
roles: [solution-architect, project-manager]
---
# Carsharing service launch with cloud-based fleet operations (GAM-CAR5)
