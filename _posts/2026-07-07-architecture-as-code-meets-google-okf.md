...
lang: en
image: /assets/og/architecture-as-code-meets-google-okf.png
---
...
![The enterprise architecture repository: field intake feeds an ingestion step, an agent splits each document and a human validates it, and the result is filed into Canon (objects and relations), Knowledge (OKF markdown) and Codex (rules and standards) — from which views are generated as PlantUML or Mermaid](/assets/articles/enterprise-architecture-repository.png)
